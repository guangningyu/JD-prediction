...
-- scoring time window user list generation
drop table if exists USER_LIST_0416_0420;
create table USER_LIST_0416_0420 as
select
USER_ID,
SKU_ID
from (
...
select count() from USER_LIST_0416_0420;
-- 1430328
--
...
where time <= DATE('2016-04-08') and time >= DATE('2016-03-23')
...
-- USER*SKU level signals
drop table if exists USER_SKU_ACTION_0201_0415;
create table USER_SKU_ACTION_0201_0415 as
select
A.USER_ID as USER_ID
,A.SKU_ID as SKU_ID
,SUM(CASE WHEN TYPE = "1" THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_CNT
...
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_CNT_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_CNT_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_CNT_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_CNT_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_CNT_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_CNT_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_1_RATE_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_2_RATE_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_3_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_4_RATE_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_5_RATE_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_6_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_4_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_4_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_4_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_4_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_4_RATE_3

,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_02_08_CNT_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_09_12_CNT_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_13_18_CNT_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_19_01_CNT_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_02_08_CNT_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_09_12_CNT_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_13_18_CNT_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_19_01_CNT_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_02_08_CNT_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_09_12_CNT_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_13_18_CNT_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_19_01_CNT_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_02_08_CNT_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_09_12_CNT_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_13_18_CNT_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_19_01_CNT_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_02_08_CNT_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_09_12_CNT_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_13_18_CNT_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_19_01_CNT_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_02_08_CNT_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_09_12_CNT_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_13_18_CNT_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_19_01_CNT_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_02_08_RATE_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_09_12_RATE_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_13_18_RATE_3
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_19_01_RATE_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_02_08_RATE_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_09_12_RATE_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_13_18_RATE_3
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_19_01_RATE_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_02_08_RATE_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_09_12_RATE_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_13_18_RATE_3
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_19_01_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_02_08_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_09_12_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_13_18_RATE_3
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_19_01_RATE_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_02_08_RATE_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_09_12_RATE_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_13_18_RATE_3
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_19_01_RATE_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_02_08_RATE_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_09_12_RATE_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_13_18_RATE_3
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 3) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_19_01_RATE_3

,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_CNT_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_CNT_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_CNT_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_CNT_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_CNT_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_CNT_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_1_RATE_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_2_RATE_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_3_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_4_RATE_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_5_RATE_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / COUNT() AS USER_SKU_TYPE_6_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_4_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_4_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_4_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_4_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <=7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_4_RATE_7

,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_02_08_CNT_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_09_12_CNT_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_13_18_CNT_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_19_01_CNT_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_02_08_CNT_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_09_12_CNT_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_13_18_CNT_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_19_01_CNT_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_02_08_CNT_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_09_12_CNT_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_13_18_CNT_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_19_01_CNT_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_02_08_CNT_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_09_12_CNT_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_13_18_CNT_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_19_01_CNT_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_02_08_CNT_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_09_12_CNT_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_13_18_CNT_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_19_01_CNT_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_02_08_CNT_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_09_12_CNT_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_13_18_CNT_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_19_01_CNT_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_02_08_RATE_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_09_12_RATE_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_13_18_RATE_7
,SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "1" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_1_19_01_RATE_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_02_08_RATE_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_09_12_RATE_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_13_18_RATE_7
,SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "2" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_2_19_01_RATE_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_02_08_RATE_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_09_12_RATE_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_13_18_RATE_7
,SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "3" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_3_19_01_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_02_08_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_09_12_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_13_18_RATE_7
,SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "4" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_4_19_01_RATE_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_02_08_RATE_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_09_12_RATE_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_13_18_RATE_7
,SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "5" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_5_19_01_RATE_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('02', '03', '04', '05', '06', '07', '08' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_02_08_RATE_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('09', '10', '11', '12' ))                   THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_09_12_RATE_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('13', '14', '15', '16', '17', '18' ))       THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_13_18_RATE_7
,SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) AND (STRFTIME('%H', TIME) in ('19', '20', '21', '22', '23', '00', '01' )) THEN 1 ELSE 0 END)*1.0 / SUM(CASE WHEN TYPE = "6" AND (JULIANDAY('2016-04-15') - JULIANDAY(TIME) <= 7) THEN 1 ELSE 0 END) AS USER_SKU_TYPE_6_19_01_RATE_7
...
select
distinct USER_ID
from USER_LIST_0416_0420
 ) B
on A.USER_ID = B.USER_ID
where time <= DATE('2016-04-15') and time >= DATE('2016-03-30')
group by A.USER_ID, A.SKU_ID;

select count() from USER_SKU_ACTION_0201_0415;
-- 3800508
